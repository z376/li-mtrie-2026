...
正式开赛前，按 [`references/赛前学习清单.md`](references/赛前学习清单.md) 准备：
...
│   ├── 赛前学习清单.md    # 备赛算法清单 + 题型映射 + 跑题红线（赛前 60/30/7 天速成）
│   ├── 提交前自检.md      # 36 项排版 + 6 项纪律 + 复检命令
│   └── AI工具使用详情-template.md  # 2026 AI 规定第 4 条模板
