...
%% \Placeholder{...} 用黑色加粗显示方括号占位符，便于交稿前搜索替换。
...
\usepackage{etoolbox}
% ctex 已在 format.cls L45 \RequirePackage, 不重复加载
...
% 不重定义 \textbf: ctex 内部用 \setCJKfamilyfont{BoldFont=...} 处理中文粗体更安全
% 中文加粗需要时用 \textbf{\song #1} 显式指定
